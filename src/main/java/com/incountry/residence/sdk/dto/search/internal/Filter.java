...
public class Filter<T> extends AbstractFilter {

    private static final ValidationHelper HELPER = new ValidationHelper(LogManager.getLogger(Filter.class));
    ...
    private static final String MSG_ERR_NULL_NUMBER_FILTER = "Filter or it's values can't be null";
    private static final String MSG_ERR_ILLEGAL_OPERATOR = "Operator in non-range filter can be only one of [NULL,$not,$lt,$lte,$gt,$gte]";
    private static final String MSG_ERR_ILLEGAL_OPERATOR_FOR_SINGLE_VALUE = "Operator in list filter can be only one of [NULL,$not]";

    private final List<T> values = new ArrayList<>();
    public final String operator;


    public Filter(T[] keys, String operator) throws StorageClientException {
    ...
    private void validate(T[] values, String operator) throws StorageClientException {
