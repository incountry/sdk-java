...
public class StorageImpl implements Storage {
    ...
    private static final String MSG_ERR_AUTH = "Please pass only one parameter combination for authorisation: clientId/clientSecret or apiKey or oauthTokenAccessor";
