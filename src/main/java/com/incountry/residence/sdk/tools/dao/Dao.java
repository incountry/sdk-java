...
public interface Dao {
    void createRecord(String country, Record record, Crypto crypto) throws StorageClientException, StorageServerException, StorageCryptoException;
    ...
    void delete(String country, String key, Crypto crypto) throws StorageServerException;
