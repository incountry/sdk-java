...
public class CryptoTest {
    ...
    @Test
    public void testEncryption() throws GeneralSecurityException, IOException, StorageDecryptionException {
    ...
    @Test(expected = StorageDecryptionException.class)
    public void testLegacyDecryption() throws GeneralSecurityException, IOException, StorageDecryptionException {
        Crypto crypto = new Crypto(secretKeysData);
    ...
    @Test
    public void testV1Decryption() throws GeneralSecurityException, IOException, StorageDecryptionException {
        Crypto crypto = new Crypto(secretKeysData);
    ...
    @Test
    public void testV2Decryption() throws GeneralSecurityException, IOException, StorageDecryptionException {
        Crypto crypto = new Crypto(secretKeysData);
