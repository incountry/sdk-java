...
public class StorageTest {
    ...
    private static String secret = "passwordpasswordpasswordpassword";
    private static int version = 0;
    private static boolean isKey = true;
    private static int currentVersion = 0;

    @BeforeEach
//    @MethodSource("initializeSecretKeyAccessorWithSecretKeyGeneratorWithIsKeyTrue")
...
//    private static SecretKeyAccessor initializeSecretKeyAccessor() {
...
//        System.out.println();
    ...
    public void batchWriteTest(String country, String key, String body, String key2, String key3, String profileKey, Integer rangeKey) throws StorageException {
        ...
        for (LinkedTreeMap response : responseList) {
            String keyFromResponse = (String) response.get("key");
...
//        jsonArray.add(encrypted);
//
//        jsonObjectMeta.addProperty("count", 1);
//        jsonObjectMeta.addProperty("limit", 10);
//        jsonObjectMeta.addProperty("offset", 0);
//        jsonObjectMeta.addProperty("total", 1);
//        jsonObject.add("data", jsonArray);
//        jsonObject.add("meta", jsonObjectMeta);

//        FakeHttpAgent agent = new FakeHttpAgent(new GsonBuilder().disableHtmlEscaping().create().toJson(jsonObject));
